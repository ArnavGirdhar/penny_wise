...
int _expenseEstimateSize(
  ...
  bytesCount += 3 + object.currMon.length * 3;
...
void _expenseSerialize(
  ...
  writer.writeString(offsets[1], object.currMon);
...
Expense _expenseDeserialize(
  ...
  final object = Expense(
    ...
    currMon: reader.readString(offsets[1]),
...
extension ExpenseQueryFilter
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> currMonEqualTo(
    String value, {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> currMonGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> currMonLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> currMonBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> currMonStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> currMonEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> currMonContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> currMonMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> currMonIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'currMon',
        value: '',
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> currMonIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'currMon',
        value: '',
...
extension ExpenseQuerySortBy on QueryBuilder<Expense, Expense, QSortBy> {
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> sortByCurrMon() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currMon', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> sortByCurrMonDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currMon', Sort.desc);
    });
  }
...
extension ExpenseQuerySortThenBy
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> thenByCurrMon() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currMon', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> thenByCurrMonDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currMon', Sort.desc);
    });
  }
...
extension ExpenseQueryWhereDistinct
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctByCurrMon(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'currMon', caseSensitive: caseSensitive);
    });
  }
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, String, QQueryOperations> currMonProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'currMon');
    });
  }
